...
class Model:
    def __init__(self):
        ...
        #self.model_ab.load_state_dict(torch.load(r"models/abnormal.pt"))
        self.model_ab.load_state_dict(torch.load(r"models\\abnormal.pt", map_location='cpu'))#torch.device('cpu')
        # try:
        #     self.model_ab.load_state_dict(torch.load(r"models/abnormal.pt"))
        # except Exception:
        #     raise FileNotFoundError('can\'t find models/abnormal.pt!')
        #self.model_ab.cuda()
    ...
    def get_prediction(self):
        try:
            axial_path = r'data/axial.npy'
            coronal_path = r'data/coronal.npy'
            sagittal_path = r'data/sagittal.npy'
        except Exception:
            raise FileNotFoundError('can\'t find data/*.npy!')
        return self.predict(self.model_ab, self.study(axial_path, coronal_path, sagittal_path))
